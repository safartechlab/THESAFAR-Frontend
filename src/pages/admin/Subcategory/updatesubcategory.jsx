...
const Updatesubcategory = () => {
  ...
  const subcategorydata = useSelector((state) => state.subcategory.subcategoryupdate)
  ...
  // populate data when subcategorydata or size list changes
  useEffect(() => {
    if (subcategorydata) {
      setsubcate({
  ...
  const update = async () => {
    try {
      const payload = {
        ...
        sizes: subcate.sizes.map((s) => s.value), // send only IDs
      }
